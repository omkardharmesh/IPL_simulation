...
for k,v in bataverage.iteritems():
    threshold[k]=(1-(float(v)/float(maxavg)))#hyper parameter
...
def predict(batsman,bowler,currprob):#will return 0->6 for runs and 10 if out
	...
	if(flag==1):
		return 10,currprob#10 is the flag indicating out
	else:
...
def prematchceremonies():
    ...
    if(toss!=t2tosschoice):
        if(batbowlchoice==0):
            ...
            print team1,"has won the toss and choose to bowl"
            comment.append(team1+" has won the toss and choose to bowl")
            tosswinlose=(team2,team1)#(team1,team2)
    else:
        if(batbowlchoice==0):
            print team2,"has won the toss and choose to bat"
            comment.append(team2+" has won the toss and choose to bat")
            tosswinlose=(team2,team1)#(team1,team2)
        else:
            print team2,"has won the toss and choose to bowl"
...
def firstinnings():
	...
	scorecard={}
	batteam,bowlteam=prematchceremonies()
